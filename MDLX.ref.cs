...
namespace dbkg
{
    ...
    {
		public MDLX(Stream stream) : base(stream, new BarEntry(null, -1, null, stream.Position, stream.Length))
		{
		...
		public class Mesh
		{
			...
			{
                public bool drawAlphaPhase	{ get {return (Integer & 0b00000000000000000000000000000001) >  0;  }}
                public bool alpha			{ get {return (Integer & 0b00000000000000000000000000000010) >  0;  }}
                public bool multi			{ get {return (Integer & 0b00000000000000000000000000000100) >  0;  }}
                public uint reserved1		{ get {return (Integer & 0b00000000000000000000000000111000) >> 3;  }}
                public uint part			{ get {return (Integer & 0b00000000000000000000011111000000) >> 6;  }}
                public uint mesh			{ get {return (Integer & 0b00000000000000001111100000000000) >> 11; }}
                public uint priority		{ get {return (Integer & 0b00000000000111110000000000000000) >> 16; }}
                public bool alphaEx			{ get {return (Integer & 0b00000000001000000000000000000000) >  0;  }}
                public uint uvScroll		{ get {return (Integer & 0b00000111110000000000000000000000) >> 22; }}
                public bool alphaAdd		{ get {return (Integer & 0b00001000000000000000000000000000) >  0;  }}
                public bool alphaSub		{ get {return (Integer & 0b00010000000000000000000000000000) >  0;  }}
                public bool specular		{ get {return (Integer & 0b00100000000000000000000000000000) >  0;  }}
                public bool noLight			{ get {return (Integer & 0b01000000000000000000000000000000) >  0;  }}
                public bool reserved2		{ get {return (Integer & 0b10000000000000000000000000000000) >  0;  }}


                public uint Integer;
                public MeshAttribute(uint val)
                {
                    this.Integer = val;
                }
            }

            public MeshAttribute SKLRAWAttribute;
            public ushort TransparentGroup;
            public ushort TransparentFlag;
            public byte UvscInfo;
				...
				while (true)
				{
					...
					if (model_type == 2)
					{
						...
						for (int poly_index = 0; poly_index < polyCount; poly_index++)
						{
							...
							if (mesh==null)
							{
								...
								mesh.TransparentGroup = this.UInt16(pos + 0x08);
								mesh.TransparentFlag = this.UInt16(pos + 0x0A);
								mesh.UvscInfo = this.Byte(pos + 0x0C);
                            }
					...
					else
					{
						...
						for (int mesh_index = 0; mesh_index < meshCount; mesh_index++)
						{
							...
							Mesh mesh = new Mesh();
							mesh.SKLRAWAttribute = new Mesh.MeshAttribute(this.UInt32(pos + 0x00));
